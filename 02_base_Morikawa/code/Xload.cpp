...
HRESULT CXLoad::Load(std::string file)
{
	...
	{
		m_XFileInfo[nIdx].nIdxTexture = new int[(int)m_XFileInfo[nIdx].dwNumMat];
	...
	// 頂点数分でメモリ確保
	m_XFileInfo[nIdx].pVtxPos = new MyLib::Vector3[m_XFileInfo[nIdx].nVtxNum];
