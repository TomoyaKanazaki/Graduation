...
public:
	CParticle();
	CParticle(D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXCOLOR col, float nLife, float nSize, int nType);
	~CParticle();

	static CParticle *Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXCOLOR col, float nLife, float nSize, int nType);
