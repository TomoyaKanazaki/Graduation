//============================================
//
//	オブジェクトメッシュドーム [objmeshDome.h]
//	Author:sakamoto kai
//
//============================================
#ifndef _OBJMESHDOME_H_
#define _OBJMESHDOME_H_

#include "main.h"
#include "object.h"

//オブジェクトメッシュフィールドクラス
class CObjmeshDome : public CObject
{
public:
	CObjmeshDome(int nPriority = 3);
	~CObjmeshDome();

	static CObjmeshDome* Create(void);
