//============================================
//
//	オブジェクトメッシュシリンダー [objmeshCulinder.h]
//	Author:sakamoto kai
//
//============================================
#ifndef _OBJMESHCYLINDER_H_
#define _OBJMESHCYLINDER_H_

#include "main.h"
#include "object.h"

//オブジェクトメッシュフィールドクラス
class CObjmeshCylinder : public CObject
{
public:
	CObjmeshCylinder(int nPriority = 3);
	~CObjmeshCylinder();

	static CObjmeshCylinder* Create(void);
