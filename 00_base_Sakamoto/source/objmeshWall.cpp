//============================================
//
//	オブジェクトメッシュウォール [objmeshWall.cpp]
//	Author:sakamoto kai
//
//============================================
...
namespace
{
	const int WAIGHT_SIZE = 6;		//横の頂点数
	const int HEIGHT_SIZE = 6;			//縦の頂点数
...
//コンストラクタ
//====================================================================
CObjmeshWall::CObjmeshWall(int nPriority) :CObject(nPriority)
{
	m_pTexture = nullptr;
	m_pVtxBuff = nullptr;
	g_pIdxBuff = nullptr;
...
//生成処理
//====================================================================
CObjmeshWall* CObjmeshWall::Create(void)
{
	CObjmeshWall* pObject3D = nullptr;

	if (pObject3D == nullptr)
	{
		//オブジェクト3Dの生成
		pObject3D = new CObjmeshWall();
	}
...
//初期化処理
//====================================================================
HRESULT CObjmeshWall::Init(void)
{
	//デバイスの取得
...
//nullptrにする処理
//====================================================================
void CObjmeshWall::SetNULL(void)
{
	//頂点バッファの破棄
...
//テクスチャの割り当て
//====================================================================
void CObjmeshWall::BindTexture(LPDIRECT3DTEXTURE9 pTexture)
{
	m_pTexture = pTexture;
}
...
//頂点座標の設定
//====================================================================
void CObjmeshWall::SetVerPos(D3DXVECTOR3 Pos0, D3DXVECTOR3 Pos1, D3DXVECTOR3 Pos2, D3DXVECTOR3 Pos3)
{
	VERTEX_3D* pVtx;	//頂点ポインタを所得
...
//テクスチャ座標の設定
//====================================================================
void CObjmeshWall::SetAnim(D3DXVECTOR2 Tex)
{
	VERTEX_3D* pVtx;	//頂点ポインタを所得
...
//頂点カラーの設定
//====================================================================
void CObjmeshWall::SetColor(D3DXCOLOR col)
{
	m_Color = col;
...
//頂点カラーの設定
//====================================================================
void CObjmeshWall::SetTexture(const char* name)
{
	CTexture* pTexture = CManager::GetInstance()->GetTexture();
