...
namespace
{
	const int WAIGHT_SIZE = 11;		//â°ÇÃí∏ì_êî
	const int HEIGHT_SIZE = 11;		//ècÇÃí∏ì_êî
	const float WAIGHT_CENTER = 0.5f;	//â°ÇÃå¥ì_(0.0fÅ`1.0f)
	const float HEIGHT_CENTER = 0.5f;	//ècÇÃå¥ì_(0.0fÅ`1.0f)
	const float FIELD_SIZE = 200.0f;	//è∞àÍñáÇÃëÂÇ´Ç≥
}
