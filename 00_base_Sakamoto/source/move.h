...
private:
    ...
    D3DXVECTOR3 MoveInputPadKey(CObjectCharacter* pCharacter, D3DXVECTOR3& pos, D3DXVECTOR3& rot, D3DXVECTOR3 Move, float fSpeed);
...
private:
    void SetJudge(int& nGridPosX, int& nGridPosZ, bool& bProgress);                  // 転がるか確認
